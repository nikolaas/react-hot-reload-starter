...
const Code = props => <code className="GetStarted__code" {...props}/>;
const Line = props => <span className="GetStarted__line" {...props}/>;
const Chapter = ({ title, children }) => (
    <section>
        {title && <h3 className="GetStarted__caption">{title}</h3>}
        {children}
    </section>
);
